...
export default function EditProject() {
  ...
  if (isFetching) {
    return (
      <div className="flex justify-center items-center mt-20 min-h-screen bg-[#0B0F19]">
    ...
    <div className="min-h-screen bg-[#0B0F19] transition-colors duration-200">
      <div className="max-w-3xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400">Update project details and settings</p>
        </div>
